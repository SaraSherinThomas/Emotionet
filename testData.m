function [testData,testLabel] = testData()
image_fl=getAllFiles('E:/ML PROJECT/Test Data/Shoulder Pain dataset/cohn-kanade-images/');

imgNo=0;
auNo=0;
imageNo=1;

for idx = 1:size(image_fl)
    lmPath=[];
    lmPath='E:\ML PROJECT\Test Data\Shoulder Pain dataset\Landmarks';
    facsPath='E:\ML PROJECT\Test Data\Shoulder Pain dataset\FACS';
